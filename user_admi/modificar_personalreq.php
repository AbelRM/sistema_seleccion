            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <?php 
                    ...
                    $sql="SELECT * FROM direccion_ejec INNER JOIN equipo_ejec ON equipo_ejec.idequipo = direccion_ejec.equipo_ejec_idequipo WHERE iddireccion='".$id."' ";
                    $result=mysqli_query($con,$sql);

                  while ($rw=mysqli_fetch_array($result))
                     {
                          $direccion=$rw['direccion_ejec'];
                          $equipo=$rw['equipo_ejec'];                      
                    }
                    ?>
