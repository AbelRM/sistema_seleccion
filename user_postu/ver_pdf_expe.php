...
<head>
  ...
  <title>Ver PDF de experiencia laboral - DIRESA TACNA </title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($datos = MySQLI_fetch_array($query)) {
            ...
            <?php } else { ?>
              <iframe src="archivos/<?php echo $dato_desencriptado ?>/expe_laboral/<?php echo $datos['archivos']; ?>" width="100%" height="1000px"></iframe>
