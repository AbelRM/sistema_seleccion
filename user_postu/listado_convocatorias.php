                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="verconvocatoria.php?id=<?php echo $row['idcon'] ?>&dni=<?php echo $dni ?>"><button type="button" class="btn btn-primary" id="editar" style="margin: 1px;"><i class="fa fa-eye"></i> Ver</button></a>
                        </td>
                      </tr>
                    <?php
                    }
