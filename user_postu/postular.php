              ...
              <div class="table-responsive">
                ...
                <form action="procesos/guardar_postulante.php" method="post">
                           ...
                           <!--  <input type="hidden" id="dni_post" name="dni_post" value="<?php echo $fila['dni']; ?>"> -->
                            ...
                            <div class="form-group row">
                               ...
                               <!--  <div class="col-md-6 col-sm-6 mb-2 mb-sm-0">
                                ...
                                <input class="form-control form-control-user" type="text" value="<?php echo $fila['nombres']." ".$fila['ape_pat']." ".$fila['ape_mat']; ?>" /> 
                                </div> -->

                                <div class="col-md-4 col-sm-6 mb-2 mb-sm-0">
                                        <label for="name1">Convocatoria</label>
                                        <select id="idcon" class="form-control" name="idcon" required>
                                            <?php
                                            include "conexion.php";  
                                            $query=$con->query("select * from convocatoria");
                                            $countries = array();
                                            while($r=$query->fetch_object()){ $countries[]=$r; }
                                            ?>
                                            <?php foreach($countries as $c):?>
                                                <option value="<?php echo $c->idcon; ?>"><?php echo $c->tipo_con; ?></option>
                                            <?php endforeach; ?>
                                        </select> 
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 mb-2 mb-sm-0">
                                <label>D.N.I.</label> 
                                <input type="text" class="form-control" id="postula_id" name="postula_id"> 
                                </div>

                                <div class="col-md-4 col-sm-6 mb-2 mb-sm-0">
                                        <label for="name1">Cargo</label>
                                        <select id="idcargo" class="form-control" name="idcargo" required>
                                            <?php
                                            include "conexion.php";  
                                            $query=$con->query("select * from cargo");
                                            $countries = array();
                                            while($r=$query->fetch_object()){ $countries[]=$r; }
                                            ?>
                                            <?php foreach($countries as $c):?>
                              ...
                              <!--   <div class="col-md-4 col-sm-6 mb-2 mb-sm-0">
                                        <label for="name1">Numero - Convocatoria</label>
                                        <select id="ConvocatoriaID" class="form-control" name="ConvocatoriaID" required>
                                            <?php
                                            include "conexion.php";  
                                            $query=$con->query("select * from convocatoria");
                                            $countries = array();
                                            ...
                                            ?>
                                            <?php foreach($countries as $c):?>
                                                <option value="<?php echo $c->idcon; ?>"><?php echo $c->num_con; ?></option>
                                            <?php endforeach; ?>
                                        </select> 
                                </div> -->                        
                    ...
                    <div class="d-flex justify-content-end">
                      <button type="input" class="btn btn-dark">Guardar</button>        
                    </div>
