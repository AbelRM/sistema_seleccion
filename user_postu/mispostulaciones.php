                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $sql3 = "SELECT * FROM detalle_convocatoria 
                      inner join personal_req on detalle_convocatoria.personal_req_idpersonal=personal_req.idpersonal 
                      INNER JOIN cargo ON personal_req.cargo_idcargo = cargo.idcargo
                      INNER JOIN ubicacion ON personal_req.personal_req_idubicacion = ubicacion.iddireccion
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px;">
                          <small style="font-weight:700; font-size: 14px;">Nº Convocatoria: </small><?php echo $row['num_con'] . "-" . $row['anio_con'] ?><br>
                          <small style="font-weight:700; font-size: 14px;">Tipo convocatoria: </small><?php echo $row['tipo_convocatoria'] ?><br>
                          <small style="font-weight:700; font-size: 14px;">Cargo a postular: </small><br><?php echo $row['cargo'] ?>
                        </td>
                        <td style="font-size: 14px;">
                          <small style="font-weight:700; font-size: 14px;">Remuneración: </small><?php echo $row['remuneracion'] ?><br>
                          <small style="font-weight:700; font-size: 14px;">Fuente financiamiento: </small><br><?php echo $row['fuente_finac'] ?><br>
                        ...
                        <td>
                          ...
                          <a href="reportes_diresa/reporte_detalles_cas.php?idcon=<?php echo $row['convocatoria_idcon'] ?>&idpersonal=<?php echo $row['personal_req_idpersonal'] ?>&idpostulante=<?php echo $idpostulante ?>&dni=<?php echo $dni ?>" target="_blank"><button type="button" class="btn btn-primary btn-sm m-1"><i class="far fa-file-pdf"></i> Reporte postulación</button></a>
