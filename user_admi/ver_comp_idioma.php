...
<head>
  ...
  <title>VER PDF CAPACITACION DE POSTULANTE - DIRESA TACNA</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($datos = MySQLI_fetch_array($query)) {
            ...
            <?php } else { ?>
              <iframe src="../user_postu/archivos/<?php echo $dni_postulante ?>/Idiomas_Computacion/<?php echo $datos['archivo']; ?>" width="1000px" height="1000px"></iframe>
