          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="row d-flex justify-content-center m-3">
                <a href="listado_postu_prac.php?idpracticas=<?php echo $idpracticas ?>&idpracticantes_req=<?php echo $idpracticantes_req ?>&dni=<?php echo $dni ?>" type="button" class="btn btn-secondary m-1"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>
                <form id="frmajax" method="POST">
                  ...
                  <button class="btn btn-primary m-1" type="submit" id="button1"><i class="fas fa-calculator"></i> Calcular puntaje</button>
                </form>
