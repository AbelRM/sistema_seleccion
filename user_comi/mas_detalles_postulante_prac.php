...
<head>
  ...
  <title>MÁS DETALLES DEL POSTULANTE PARA EVALUACIÓN CURRICULAR - DIRESA TACNA</title>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <h6 class="m-0 font-weight-bold text-success">Formación academica del postulante (8 puntos)</h6>
                    <hr class="sidebar-divider">
                  </div>
                  <form action="procesos/actualizar_validacion.php" method="POST">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6 col-sm-6">
                        ...
                        <a href="ver_formacion.php?id=<?php echo $fila_4['idformacion_acad_prac'] ?>&dni_postulante=<?php echo $dni_postulante ?>&dni=<?php echo $dni ?>" target=" _blank"><i class="fas fa-file-pdf"></i> <?php echo $fila_4['archivo']; ?></a>
                      </div>
                      <div class="form-group col-md-6 col-sm-12">
                      ...
                      <div class="form-group col-md-12 col-sm-12">
                        ...
                        <textarea class="form-control" name="observaciones" id="observaciones_selec" placeholder="Especificar la razon del cambio en la validación..." rows="3"><?php echo $fila_4['observaciones_selec'] ?></textarea>
                      </div>
                      <div class="col-md-12 col-sm-12 d-flex justify-content-center">
                        <button class="btn btn-success" name="updateFormacion_2" type="submit">Actualizar</button>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <div class="form-group">
                <h6 class="m-0 font-weight-bold text-danger">Lista de Capacitaciones registradas (1p por c/curso, máximo 5 puntos)</h6>
                <hr class="sidebar-divider">
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px;"><?php echo $row['centro_estu'] ?></td>
                        <td style="font-size: 14px;"><?php echo $row['materia'] ?></td>
                        ...
                        <td style="font-size: 14px;">
                          <a href="ver_diplomado.php?id=<?php echo $row['idcursos_extra'] ?>&dni=<?php echo $dni_postulante ?>" target="_blank"><i class="fas fa-file-pdf"></i> <?php echo $row['archivo']; ?></a>
                        </td>
              ...
              <!-- SE ESTA MOSTRANDO LA PARTE DE PERSONAL REQUERIDO -->
              <div class="form-group">
                <h6 class="m-0 font-weight-bold text-danger">Lista de Idiomas (Máximo 1p) - Computación (1p c/curso, máximo 3p) - Liderazgo (Máximo 1p)</h6>
                <hr class="sidebar-divider">
              </div>
              <div class="table-responsive">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px;">
                          <a href="ver_diplomado.php?id=<?php echo $rw['idcursos_extra'] ?>&dni=<?php echo $dni_postulante ?>" target="_blank"><i class="fas fa-file-pdf"></i> <?php echo $rw['archivo']; ?></a>
                        </td>
              ...
              <div class="row d-flex justify-content-center m-3">
                <a href="lista_postu_prac_total.php?idpracticas=<?php echo $idpracticas ?>&idpracticantes_req=<?php echo $idpracticantes_req ?>&dni=<?php echo $dni ?>#totales" type="button" class="btn btn-secondary m-1"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>

                <form action="procesos/calcular_puntaje_prac.php" method="POST">
                  ...
                  <button class="btn btn-primary m-1" type="submit"><i class="fas fa-calculator"></i> Calcular puntaje</button>
                </form>
      ...
      <div class="modal-content">
        ...
        <form action="procesos/actualizar_validacion.php" method="POST">
          <div class="modal-body">
            <div class="row">
              ...
              <div class="form-group col-md-12 col-sm-12">
                ...
                <textarea class="form-control" name="observaciones_curso" placeholder="Especificar la razon del cambio en la validación..." rows="3"></textarea>
              </div>
            </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary m-1" name="updateCurso_2">Actualizar</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form action="procesos/actualizar_validacion.php" method="POST">
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-12 col-sm-12">
                ...
                <textarea class="form-control" name="observaciones_idioma" placeholder="Especificar la razon del cambio en la validación..." rows="3"></textarea>
              </div>
            </div>
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-secondary m-1" data-dismiss="modal">Cancelar</button>
            <button type="submit" class="btn btn-primary m-1" name="updateIdioma_2">Actualizar</button>
          </div>
        </form>
      </div>
    </div>
          ...
          success: function(r) {
            ...
            if (respuesta.r == 1) {
              Swal.fire({
                ...
                window.location = "lista_postulante_prac_total.php?dni=" + respuesta.dni;
              });
            } else {
              Swal.fire({
  ...
  <script>
    $(document).ready(function() {
      $('.updateBtn').on('click', function() {
        ...
        $('#fecha_fin').val(data[6]);
        $('#tipo').val(data[7]);
        $('#archivos').val(data[8]);
        $('#validacion_curso').val(data[9]);
      });
