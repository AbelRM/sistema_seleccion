        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <!-- FORMACION ACADEMICA -->
              <div class="form-group" id="formacion_academica">
                  ...
                  <form action="procesos/actualizar_validacion.php" method="POST">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-12 col-sm-12">
                        ...
                        <textarea class="form-control text-danger font-weight-bold" name="observaciones" id="observaciones_selec" placeholder="Especificar la razon del cambio en la validación..." rows="3"><?php echo $fila_form['observaciones_selec'] ?>
                        </textarea>
                      </div>
              ...
              <div class="table-responsive" id="tabla_postgrado">
              ...
              <div class="table-responsive" id="tabla_capacitaciones">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="display:none">id</th>
              ...
              <div class="table-responsive" id="tabla_idiomas">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="display:none">id</th>
              ...
              <!-- SE ESTA MOSTRANDO LA EXPERIENCIA LABORAL -->
              <div class="form-group">
                <h6 class="m-0 font-weight-bold text-primary">Lista de Experiencia laboral registrada</h6>
                <hr class="sidebar-divider">

                <div class="table-responsive" id="tabla_experiencia">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th style="display:none">id</th>
        ...
        <form action="procesos/actualizar_validacion.php" method="POST">
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-12 col-sm-12">
                <label for="observaciones_idioma">Observaciones de la experiencia.</label>
