            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">POSTULACION C.A.S. SELECCIONADA</h6>
                </div>
                <div class="card-body">
                  <?php
                  ...
                  $idcon =  intval($_GET['id']);
                  $detalle = intval($_GET['id']);
                  ...
                  <div class="row d-flex justify-content-center m-3">
                    <a href="mispostulaciones.php?dni=<?php echo $dni ?>" type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>
                  </div>
