          ...
          <div class="row">
                  ...
                  <div class="col-xl-12 col-md-12 mb-4">
                    <div class="card border-left-warning shadow h-100 py-2">
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-md-12 p-2 d-flex justify-content-center">
                            <h3 class="text-xs font-weight-bold text-warning  text-uppercase mb-1">Idiomas - Computación - Liderazgo</h3>
                          </div>
                          <div class="col-md-12 p-2">
                            <div class="table-responsive">
                              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <div class="col-2 p-0">
              <div class="list-group" id="list-tab" role="tablist" style="font-size:12px;">
                <a class="list-group-item list-group-item-action active" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">Diplomados - Cursos</a>
                <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Idioma - Computación - Liderazgo</a>
              </div>
            </div>
            ...
            <form action="procesos/guardar_capacitacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-9 col-sm-12 form-group">
                  ...
                  <input type="text" style="text-transform: uppercase; font-size:13px;" name="centro_estudios" class="form-control" placeholder="Nombre centro estudios" maxlength="150" required>
                </div>
                <div class="col-md-9 col-sm-12 form-group">
                  <label for="title">(*) Nombre del curso</label>
                  <input type="text" id="materia" name="materia" style="text-transform: uppercase; font-size:13px;" class="form-control" placeholder="Materia" maxlength="150" required>
                </div>
                <div class="col-md-3 col-sm-12 form-group">
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="insert_diplomado_prac">Guardar</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <form action="procesos/guardar_capacitacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 form-group">
                  <label for="title">(*) Idioma - Computación - Adicional</label>
                  <select id="idioma" name="idioma" class="form-control" required>
                    ...
                    <option value="MOTIVACION / LIDERAZGO">Motivación / Liderazgo</option>
                  </select>
                </div>
                <div class="col-md-12 col-sm-12 form-group">
                  <label for="title">(*) Centro de estudios</label>
                  <input type="text" style="text-transform: uppercase; font-size:13px;" name="centro_estudios_idio" class="form-control" placeholder="Nombre centro estudios" maxlength="150" required>
                </div>
                <div class="col-md-12 col-sm-12 form-group">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="insert_idioma_prac">Guardar</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div class="modal-body">
            <form action="procesos/actualizar_estudiosup.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-9 col-sm-12 form-group">
                  <label for="title">Centro de estudios</label>
                  <input type="text" name="centro_estud" style="text-transform: uppercase; font-size:13px;" id="centro_estud" class="form-control">
                </div>
                <div class="col-md-9 col-sm-12 form-group">
                  <label for="title">Materia </label>
                  <input type="text" name="materia1" style="text-transform: uppercase; font-size:13px;" id="materia1" class="form-control">
                </div>
                <div class="col-md-3 col-sm-12 form-group">
                  <label for="title">Horas </label>
                  <input type="number" name="horas1" id="horas1" class="form-control" placeholder="Horas" maxlength="50">
                </div>
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-primary" name="updateCursosPrac">Actualizar!</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <div class="modal fade" id="actualizaridiomas">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="procesos/actualizar_estudiosup.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                 <label for="title">(*) Centro de estudios</label>
                 <input type="text" style="text-transform: uppercase; font-size:13px;" name="centro_estudios_idio" class="form-control" id="lugar_estudio" maxlength="150" required>
              </div>
              <div class="form-group">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="updateIdiomaPrac">Actualizar</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <form action="procesos/eliminar_capacitacion.php" method="POST">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" name="deleteCursoPrac">Si</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="procesos/eliminar_capacitacion.php" method="POST">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
              <button type="submit" class="btn btn-primary" name="deleteData3" id="deleteIdiomaPrac">Si</button>
            </div>
          </form>
          <!-- name="deleteData3" -->
        </div>
