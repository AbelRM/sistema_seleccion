              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM practicantes_req INNER JOIN ubicacion ON practicantes_req.practicantes_req_idubicacion= ubicacion.iddireccion WHERE conv_idpracticas = $idpracticas";
                    ...
                    ?>
                        <tr style="background-color: #8287e061;">
                          ...
                          <td style="font-size: 12px;">
                            ...
                            <small style="font-weight:700; font-size: 14px;">Carrera requerida: </small><?php echo $row['carrera_prof'] ?><br>
                          ...
                          <td>
                            <a href="registrar_post_prac.php?idpracticantes_req=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>&idpracticas=<?php echo $idpracticas ?>">
