        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="d-flex justify-content-center">
              <a href="reportes_diresa/reporte_detalles_cas.php?idpostulante=<?php echo $idpostulante ?>&idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>"><button type="button" class="btn btn-primary m-3"><i class="fa fa-book"></i> Generar ficha de detalles</button></a>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-row">
                    <div class="form-group col-md-6 col-sm-6">
                      ...
                      <select class="form-control" style="font-size: 12px;" name="id_cargo_especifico" id="id_cargo_especifico">
                        <?php
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4 col-sm-6" id="div_tipo_estudio_max">
                      ...
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php if ($fila_4['reque_tipo_estudios_max'] == 1) {
                                                                                                echo "SECUNDARIA";
                                                                                              } elseif ($fila_4['reque_tipo_estudios_max'] == 2) {
                    ...
                    <div class="form-group col-md-4 col-sm-6" id="div_nivel_estudio_max">
                      ...
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php echo $fila_4['nivel_estudio_max'] ?>" disabled="true">
                    </div>
                    <div class="form-group col-md-4 col-sm-6" id="div_ciclo_req_max">
                      <label for="inputEmail4">Ciclo requerido máximo</label>
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php echo $fila_4['ciclo_actual_max'] ?>" disabled="true">
                    </div>
                    <div class="form-group col-md-4 col-sm-6" id="div_colegiatura_max">
                      <label for="inputEmail4">Colegiatura</label>
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php echo $fila_4['colegiatura_max'] ?>" disabled="true">
                    </div>
                    <div class="form-group col-md-4 col-sm-6" id="div_habilitacion_max">
                      <label for="inputEmail4">Habilatación</label>
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php echo $fila_4['habilitacion_max'] ?>" disabled="true">
                    </div>
                    <div class="form-group col-md-4 col-sm-6" id="div_serums_max">
                      <label for="inputEmail4">SERUMS</label>
                      <input type="text" class="form-control" style="font-size: 13px;" value="<?php echo $fila_4['serums_max'] ?>" disabled="true">
                    </div>
                  ...
                  <form action="procesos/actualizar_validacion.php" method="POST">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4 col-sm-12" id="div_tipo_estudio_post">
                        ...
                        <input type="text" class="form-control" style="text-transform: uppercase; font-size: 12px;" value="<?php echo $fila_form['tipo_estudios'] ?>" disabled="true">
                      </div>
                      <div class="form-group col-md-4 col-sm-12" id="div_nivel_estudio_post">
                        ...
                        <input type="text" class="form-control" style="text-transform: uppercase; font-size: 12px;" value="<?php echo $fila_form['nivel_estudios'] ?>" disabled="true">
                      </div>
              ...
              <div class="table-responsive" id="lista_postgrado">
              ...
              <div class="table-responsive" id="lista_capacitaciones">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="display:none">id</th>
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                    ?>
                      <tr id="<?php echo $row['idcursos_extra'] ?>">
                        ...
                        <td style="font-size: 12px;">
                          <a href="ver_diplomado.php?id=<?php echo $row['idcursos_extra'] ?>&dni_postulante=<?php echo $dni_postulante ?>&dni=<?php echo $dni ?>" target="_blank"><i class="fas fa-file-pdf"></i> <?php echo $row['archivo']; ?></a>
                        </td>
              ...
              <div class="table-responsive" id="lista_idiomas">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="display:none">id</th>
                  ...
                  <tbody>
                    <?php
                    $idioma_compu = "SELECT * FROM idiomas_comp WHERE idpostulante_postulante = '$idpostulante'";
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px;">
                          <a href="ver_comp_idioma.php?id=<?php echo $rw['ididiomas_comp'] ?>&dni_postulante=<?php echo $dni_postulante ?>&dni=<?php echo $dni ?>" target="_blank"><i class="fas fa-file-pdf"></i> <?php echo $rw['archivo']; ?></a>
                        </td>
              ...
              <div class="form-group">
                ...
                <div class="table-responsive">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php
                      $experiencia = "SELECT * FROM expe_4puntos INNER JOIN lugar_trabajo_gene 
              ...
              <div class="row">
                <div class="col-6 d-flex justify-content-center">
                  <a href="listado_postu_cas.php?&idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>" class="btn btn-secondary" type="button"><i class="fas fa-arrow-circle-left"></i> Retroceder</a>
                </div>
                <div class="col-6 d-flex justify-content-center">
                  <a href="listado_postu_cas.php?&idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>" class="btn btn-success" type="button"><i class="fas fa-check-circle"></i> Validar cambios</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 form-group">
                ...
                <select name="validacion_curso" id="validacion_curso" class="form-control">
                  <option value="VALIDO">VÁLIDO</option>
                  <option value="NO VALIDO">NO VÁLIDO</option>
                  <option value="OBSERVADO">OBSERVADO</option>
                </select>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form action="procesos/actualizar_validacion.php" method="POST">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-secondary m-1" data-dismiss="modal">Cancelar</button>
            <button type="submit" class="btn btn-primary m-1" name="updateExpCAS">Actualizar</button>
          </div>
        </form>
      </div>
    </div>
          ...
          success: function(r) {
            ...
            if (respuesta.r == 1) {
              Swal.fire({
                ...
                window.location = "listado_postu_cas.php?idcon=" + respuesta.idcon + "&idpersonal=" + respuesta.idpersonal + "&dni=" + respuesta.dni + "#curricular";
              });
            } else {
              Swal.fire({
