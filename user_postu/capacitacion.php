...
<head>
  ...
  <title>Capacitaciones para postulantes de CAS - DIRESA - TACNA</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        $consulta = "SELECT * FROM postulante where dni=$dato_desencriptado";
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class="mb-0 text-gray-800 font-weight-bold">MIS DATOS ACADÉMICOS:</h5>
          </div>
          <div class="row">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                      <tr>
                                        ...
                                        <td><a href="verpostgrado.php?id=<?php echo $row3['idmaestria_doc'] ?>&dni=<?php echo $dni ?>" target="_blank"><?php echo $row3['archivo']; ?></a></td>
                                ...
                                <tbody>
                                  ...
                                  ?>
                                      <tr>
                                        ...
                                        <td><a href="ver_diplomados.php?id=<?php echo $row3['idcursos_extra'] ?>&dni=<?php echo $dni ?>" target="_blank"><?php echo $row3['archivo']; ?></a></td>
                                        <td class="d-flex justify-content-center">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                      <tr>
                                        ...
                                        <td><a href="ver_idiomas.php?id=<?php echo $row4['ididiomas_comp'] ?>&dni=<?php echo $dni ?>" target="_blank"><?php echo $row4['archivo']; ?></a></td>
                                        <td class="d-flex justify-content-center">
          ...
          <div class="row d-flex justify-content-center m-3">
            <a href="ingreso_datos_prof.php?dni=<?php echo $dni ?>" type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>
          </div>
          <!-- /.container-fluid -->
        </div>
        <!-- End of Main Content -->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">Estudios Postgrado (Maestrias - Doctorados - Especialidad)</h5>
          ...
          <div class="modal-body">
            <form action="procesos/guardar_capacitacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                <input type="hidden" name="dni_encriptado" value="<?php echo $dni ?>">
                ...
                <div class="col-md-3 col-sm-12 form-group" id="div_nivel_estudio">
                  <label for="tipo">(*) Tipo estudios</label>
                  <select name="tipo" id="tipo" class="form-control" onChange="tipo_estudios(this)">
                    <option value="MAESTRIA">Maestria</option>
                    <option value="DOCTORADO">Doctorado</option>
                    <option value="ESPECIALIDAD">Especialidad</option>
                  </select>
                </div>
                <div class="col-md-3 col-sm-12 form-group" id="div_registro_especialidad">
                  <label for="title">Registro especialidad</label>
                  <input type="text" style="text-transform: uppercase;" name="registro_especialidad" class="form-control">
                </div>
                <div class="col-md-3 col-sm-12 form-group" id="div_nivel_estudio">
                ...
                <div class="col-md-6 col-sm-12 form-group" id="div_centro_estudios">
                  ...
                  <input type="text" id="centro_estudios" style="text-transform: uppercase; font-size: 12px;" name="centro_estudios" class="form-control" placeholder="Nombre centro estudios" maxlength="100" required>
                </div>
                <div class="col-md-6 col-sm-12 form-group" id="div_centro_estudios">
                  <label for="especialidad">(*) Nombre maestria/doctorado/especiaidad</label>
                  <input type="text" id="especialidad" name="especialidad" style="text-transform: uppercase; font-size: 12px;" class="form-control" placeholder="Nombre completo de lo estudiado" required>
                </div>
                ...
                <div class="col-md-8 col-sm-12 form-group">
                  ...
                  <input type="file" name="archivo1" accept=".pdf" id="expe2_archivo" class="form-control" required />
              ...
              <div class="row">
                  <div class="col-lg-12 ol-md-12 col-sm-12 form-group">
                    ...
                    <ol class="text-danger font-weight-bold">
                      <li>Un crédito equivale a 16 horas</li>
                      <li>Todo curso, diplomado, etc. debe estar sustentando con el archivo de constancia o certificado.</li>
                      <li>En caso de subir algun archivo incorrecto, abtenerse a sanciones.</li>
                    </ol>
                  </div>
                ...
                <input type="hidden" name="dni" value="<?php echo $dato_desencriptado ?>">
                <input type="hidden" name="postulante" value="<?php echo $idpostulante ?>">
                <div class="col-lg-3 col-md-3 col-sm-12 form-group" id="div_nivel_estudio">
                ...
                <div class="col-lg-9 ol-md-9 col-sm-12 form-group" id="div_centro_estudios">
                  <label for="title">(*) Centro estudios</label>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 form-group" id="div_centro_estudios">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 form-group" id="div_centro_estudios">
                  <label for="title">(*) Horas</label>
                  <input type="number" id="horas" name="horas" class="form-control" value="0"  required>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 form-group" id="div_centro_estudios">
                  <label for="title">(*) N° créditos</label>
                  <input type="number" id="creditos" name="creditos" class="form-control" value="0" >
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 form-group" id="div_fecha_inicio">
                  <label for="title">(**) Fecha Inicio</label>
                  <input type="date" id="fecha_inicio" name="fecha_inicio" class="form-control" required>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 form-group" id="div_fecha_fin">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                  ...
                  <input type="file" name="archivo" accept=".pdf" class="form-control" id="expe4_archivo" required />
            ...
            <form action="procesos/guardar_capacitacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 form-group">
                  ...
                  <select  name="idiomas_comp" class="form-control" required>
                    <option>Elegir...</option>
                    <option value="IDIOMA">Idioma</option>
                    <option value="COMPUTACION/OFIMATICA">Computación / Ofimática</option>
                  </select>
                </div>
                <div class="col-md-12 col-sm-12 form-group">
    ...
    <div class="modal fade" id="actualizarpostgrado">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="procesos/actualizar_estudiosup.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                <input type="hidden" name="dato_desencriptado" id="dato_desencriptado" value="<?php echo $dni ?>">
                <input type="hidden" name="idmaestria_doc" id="idmaestria_doc">
                <input type="hidden" name="dni2" name="dni2" value="<?php echo $dato_desencriptado ?>">
                ...
                <div class="col-md-6 col-sm-12 form-group">
                  <label for="title">Centro de estudios</label>
                  <input type="text" name="centro_estudi" style="text-transform: uppercase; font-size: 12px;" id="centro_estudi" class="form-control">
                </div>
                <div class="col-md-6 col-sm-12 form-group">
                  <label for="title">Nombre de maestria/doctorado/especialidad</label>
                  <input type="text" name="especialidades" style="text-transform: uppercase; font-size: 12px;" id="especialidades" class="form-control">
                </div>
          ...
          <div class="modal-body">
            <form action="procesos/actualizar_estudiosup.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <input type="hidden" name="dni3" name="dni3" value="<?php echo $dato_desencriptado ?>">
                <div class="col-md-3 col-sm-12 form-group">
                ...
                <div class="col-md-9 col-sm-12 form-group">
                  <label for="title">Centro de estudios</label>
                  <input type="text" name="centro_estud" style="text-transform: uppercase; font-size: 12px;" id="centro_estud" class="form-control">
                </div>
                <div class="col-md-9 col-sm-12 form-group">
                  <label for="title">Materia </label>
                  <input type="text" name="materia1" style="text-transform: uppercase; font-size: 12px;" id="materia1" class="form-control">
                </div>
                <div class="col-md-3 col-sm-12 form-group">
                  <label for="title">Horas </label>
                  <input type="number" name="horas1" id="horas1" class="form-control" value="0" maxlength="50">
                </div>
                <div class="col-md-3 col-sm-12 form-group">
                  <label for="title">N° creditos </label>
                  <input type="number" name="creditos1" id="creditos1" class="form-control" value="0" maxlength="50">
                </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="procesos/actualizar_estudiosup.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              ...
              <input type="hidden" name="dato_desencriptado" id="dato_desencriptado" value="<?php echo $dni ?>">
              <input type="hidden" name="ididiomas_comp" id="ididiomas_comp">
              <input type="hidden" name="dni4" name="dni4" value="<?php echo $dato_desencriptado ?>">
              <div class="form-group">
                <label for="title">Idiomas/Computacion</label>
                  <select id="select_idio_compu" name="idioma_comp" class="form-control" required>
                    <option value="IDIOMA">Idioma</option>
                    <option value="COMPUTACION/OFIMATICA">Computación / Ofimática</option>
                  </select>
              </div>
              <div class="form-group">
                <label for="title">(*) Centro de estudios</label>
                <input type="text" id="lugar_estudio" style="text-transform: uppercase; font-size:13px;" name="centro_estudios_idio" class="form-control" placeholder="Nombre centro estudios" maxlength="150">
              </div>
              <div class="form-group">
                <label for="title">Nivel</label>
