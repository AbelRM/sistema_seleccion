...
$select = "SELECT * FROM postulante WHERE idpostulante ='$idpostulante' ";
...
$select_1 = "SELECT * FROM formacion_acad_prac INNER JOIN carrera ON formacion_acad_prac.id_carrera = carrera.idcarrera WHERE formacion_acad_prac_idpostulante ='$idpostulante' ";
...
if ($num_fil_form > 0) {
  ...
  $carrera_postu = $row['nomb_carrera'];

  $select_2 = "SELECT * FROM practicantes_req INNER JOIN carrera ON practicantes_req.id_carrera_req = carrera.idcarrera WHERE idpracticantes_req ='$personal_req' ";
  ...
  $carrera_req = $rw['nomb_carrera'];

  $select_3 = "SELECT * FROM detalle_conv_prac WHERE idpracticas_conv ='$idcon' AND detalle_prac_idpostulante = '$idpostulante' AND practicantel_req_idpracticantes_req = '$personal_req'";
    ...
    if (isset($id_practicas) or isset($id_convocatoria)) {
      ...
      if (!isset($resultado_3)) {
        ...
        if ($carrera_req == $carrera_postu) {
          ...
          $responder =  array('r' => 0, 'dni' => $dni, 'mensaje' => "Su carrera profesional no es requerida para esta convocatoria.");
          echo json_encode($responder, JSON_UNESCAPED_UNICODE);
        }
      }
    }
