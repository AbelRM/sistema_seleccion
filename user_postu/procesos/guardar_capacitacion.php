...
if (isset($_POST['insertData'])) {
  ...
  if (!(strpos($tipo_archivo, "pdf") && ($tamano_archivo <= 3000000))) {
    ...
    if (move_uploaded_file($_FILES['archivo1']['tmp_name'], $micarpeta . $new_nombre)) {
      ...
      $sql = "INSERT INTO maestria_doc (centro_estu,especialidad,tipo_estu,fech_ini,fech_fin,nivel,archivo, idpostulante_postulante,postgrado_validacion) 
            VALUES('$centro_estudios','$especialidad','$tipo','$fecha_inicio','$fecha_fin','$nivel','$new_nombre', '$idpostulante','$validacion')";
