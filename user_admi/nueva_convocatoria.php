            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">NUEVA CONVOCATORIA CAS</h6>
                </div>
                <div class="card-body">
                  <form action="procesos/guardar_nueva_convo.php" class="needs-validation" method="POST">
                    ...
                    <div class="form-row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <input type="text" class="form-control sumar" name="curricular" id="curricular" required>
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <input type="text" class="form-control sumar" name="entrevista" id="entrevista" required>
                          </div>
                          <label for="staticEmail" class="col-sm-4 col-form-label">%</label>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-6 d-flex justify-content-end">
                        <button type="submit" name="convoc_cas" class="btn btn-danger">Siguiente <i class="fas fa-arrow-circle-right"></i></button>
                      </div>
                    </div>
                  </form>
                </div>
