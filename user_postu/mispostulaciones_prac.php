...
<head>
  ...
  <title>MIS POSTUACIONES - DIRESA TACNA</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">MIS POSTULACIONES DE PRACTICAS</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                    $sql3 = "SELECT * FROM detalle_conv_prac
                      ...
                      WHERE detalle_prac_idpostulante='$idpostulante'";
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="ver_postulaciones_prac.php?id=<?php echo $row['iddetalle_conv_prac'] ?>&dni=<?php echo $dni ?>"><button type="button" class="btn btn-primary btn-sm" id="editar" style="margin: 1px;"><i class="fa fa-eye"></i> Ver</button></a>
                          <button type="button" class="btn btn-danger btn-sm deleteBtn"><i class="fa fa-eye"></i> Anular</button>
