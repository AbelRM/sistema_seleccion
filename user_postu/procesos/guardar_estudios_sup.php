  ...
  if(ISSET($_POST['insertData']))     
    {
      ...
      $query = mysqli_query($con, "SELECT * FROM estudios_superiores WHERE idestudios = $idpostulante");
      ...
      if (!(strpos($tipo_archivo, "pdf") && ($tamano_archivo <= 3000000))) {
        ...
        if (move_uploaded_file($_FILES['archivo']['tmp_name'], $micarpeta . $new_nombre)) {
          ...
          $fecha_fin = $_POST['fecha_fin'];
            ...
            VALUES('$centro_estudios','$especialidad','$fecha_inicio','$fecha_fin','$nivel','$idpostulante','$new_nombre')";  
