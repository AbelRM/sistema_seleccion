            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $consulta_form = "SELECT * FROM formacion_acad_prac
                    INNER JOIN carrera ON formacion_acad_prac.id_carrera = carrera.idcarrera
                    WHERE formacion_acad_prac_idpostulante = '$idpostulante'";
            ...
            <form action="procesos/guardar_formacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12 form-group" id="div_carrera">
                  <label for="title">(*) Carrera profesional</label>
                  <select name="carrera" class="form-control">
                    <option value="0" class="font-weigh-bold">Seleccione:</option>
                    <?php
                    $query = $con->query("SELECT * FROM carrera");
                    while ($valores = mysqli_fetch_array($query)) {
                      echo '<option value="' . $valores['idcarrera'] . '">' . $valores['nomb_carrera'] . '</option>';
                    }
                    ?>
                  </select>
                </div>
