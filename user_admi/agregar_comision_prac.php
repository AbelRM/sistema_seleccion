                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="procesos/guardar_comision.php">
                        ...
                        <table class="table table-bordered" id="tabla">
                          ...
                          <tbody>
                            <tr class="fila-fija">
                              ...
                              <td class="eliminar"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i>Eliminar</button></td>
                            </tr>
                            </tdody>
                        </table>
                      </div>
                    ...
                    <div class="row d-flex justify-content-center">
                      ...
                      <div class="form-inline p-2">
                        <input type="submit" name="insertar_comi_prac" class="btn btn-primary" value="GUARDAR" />
                      </div>
                    </div>
                  </form>
                </div>
