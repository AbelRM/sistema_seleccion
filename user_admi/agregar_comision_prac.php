            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">AGREGAR DATOS DE LA COMISIÓN PARA LA CONVOCATORIA DE PRACTICANTES</h6>
                </div>
                <div class="card-body">
                  <?php
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="font-size: 14px;"><?php echo $row['nomb_carrera'] ?></td>
                  ...
                  <form method="POST" action="procesos/guardar_comision.php">
                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-danger">Datos de la comisión encargada del proceso de convocatoria</h6>
                      <hr class="sidebar-divider">
                    </div>
                    ...
                    <div class="table-responsive" id="tabla_comision">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <?php
                          $consulta_form = "SELECT * FROM comision_pract WHERE practicas_idcon = '$practicas_idcon'";
                          $query = mysqli_query($con, $consulta_form);
                          ...
                          ?>
                              <tr style="text-align:center;">
                                <td style=" font-size: 12px; display:none;"><?php echo $row['idcomision_pract'] ?></td>
                  ...
                  <div class="card-footer d-flex justify-content-end">
                    <a href="resumen_convoc_prac.php?practicas_idcon=<?php echo $practicas_idcon ?>&dni=<?php echo $dato_desencriptado ?>" type="button" class="btn btn-primary">Finalizar <i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body">
          <form action="procesos/guardar_comision.php" autocomplete="off" method="POST">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" name="agregar_comision_prac" class="btn btn-primary">Guardar</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="procesos/guardar_comision.php" autocomplete="off" method="POST">
            ...
            <div class="modal-footer">
              <button data-dismiss="modal" class="btn btn-secondary">Salir</button>
              <button type="submit" name="actualizar_comision_prac" class="btn btn-primary">Actualizar</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <form action="procesos/guardar_comision.php" method="POST">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-danger" name="deleteComision_prac">SI</button>
          </div>
