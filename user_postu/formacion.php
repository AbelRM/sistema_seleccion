...
<body id="page-top">
  ...
  <div id="wrapper">
            ...
            <form action="procesos/guardar_formacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12 form-group" id="div_centro_estudios">
                  ...
                  <input type="text" name="centro_estudios" class="form-control" placeholder="Nombre centro estudios" maxlength="100" required>
                </div>
                <div class="col-md-3 col-sm-12 form-group" id="div_tipo_profesion" style="display: none;">
                  <label for="title">(*) Profesión a postular</label>
                  <select name="tipo_profesion" onChange="tipo_profesion_select(this)" class="form-control">
                    <option value="0">Seleccione:</option>
                    <option value="chofer">Chofer</option>
                    <option value="vigilante">Vigilante</option>
                    <option value="limpieza">Trabajador de Limpieza</option>
                    <option value="otros_servicios">Trabajador de servicios</option>
                  </select>
                </div>
                <div class="col-md-3 col-sm-12 form-group" id="div_categoria_brevete" style="display: none;">
                  <label for="title">(*) Categoria de Brevete</label>
                  <select name="categoria_brevete" class="form-control">
                    <option value="0">Seleccione:</option>
                    <option value="ESTUDIANTE">A-I</option>
                    <option value="EGRESADO">A-IIa</option>
                    <option value="BACHILLER">A-IIb</option>
                    <option value="TITULADO">A-IIIa</option>
                    <option value="TITULADO">A-IIIb</option>
                    <option value="TITULADO">A-IIIc</option>
                  </select>
                </div>
                ...
                <div class="col-md-6 col-sm-12 form-group" id="archivo">
                  <div class="row">
                    <label for="title">(*) Elegir Archivo de obtencion de titulo</label>
                  </div>
                  <div class="row">
                    <div class="col-4 pf-0">
                      ...
                      <input id="file-upload" onchange='cambiar()' accept=".pdf" name="archivo" type="file" style='display: none;' required />
                    </div>
                    <div class="col-8 p-0">
              ...
              <div class="form-group">
                ...
                <p>(**) En el campo "FECHA" debe indicar la fecha de obtención del "TITULO DE ESTUDIOS" que está registrando.
    ...
    <script>
      function tipo_estudios_select(sel) {
        if (sel.value == "1") {
          ...
          div_centro_estudios = document.getElementById("div_tipo_profesion");
          div_centro_estudios.style.display = "block";
          ...
          div_centro_estudios.style.display = "block";
          div_centro_estudios = document.getElementById("div_tipo_profesion");
          div_centro_estudios.style.display = "none";
          div_centro_estudios = document.getElementById("div_categoria_brevete");
          div_centro_estudios.style.display = "none";
          div_carrera = document.getElementById("div_carrera");
    ...
    <script>
      function tipo_profesion_select(sel) {
        if (sel.value == "chofer") {
          div_nivel_estudio = document.getElementById("div_categoria_brevete");
          div_nivel_estudio.style.display = "block";
          // divC = document.getElementById("nCuenta");
          // divC.style.display = "block";
          // max = document.getElementById("dni");
          // max.setAttribute("maxlength", "8");
        } else if (sel.value == "vigilante") {
          div_nivel_estudio = document.getElementById("div_categoria_brevete");
          div_nivel_estudio.style.display = "none";
        } else if (sel.value == "limpieza") {
          div_nivel_estudio = document.getElementById("div_categoria_brevete");
          div_nivel_estudio.style.display = "none";
        } else if (sel.value == "otros_servicios") {
          div_nivel_estudio = document.getElementById("div_categoria_brevete");
          div_nivel_estudio.style.display = "none";
        }
      }
