                  ...
                  <div class="form-group row">
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <?php
                          $sql5 = "SELECT * FROM expe_4puntos WHERE expe_4puntos_idpostulante = $idpostulante
                                          UNION
                                          SELECT * FROM expe_3puntos WHERE expe_3puntos_idpostulante = $idpostulante
                                          UNION
                                          SELECT * FROM expe_1puntos WHERE expe_1puntos_idpostulante = $idpostulante";
                          $query5 = mysqli_query($con, $sql5);
                          if (mysqli_num_rows($query5) > 0) {
                            while ($row5 = MySQLI_fetch_array($query5)) {
                          ?>
