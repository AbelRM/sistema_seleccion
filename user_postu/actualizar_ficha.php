...
<body id="page-top">
          ...
          <div class="row justify-content-center">
            <div class="col-12 text-center ">
              <div class="card border-primary mb-3">
                ...
                <div id="formp1" class="card-body">
                  <form id="msform" method="post">
                    ...
                    <fieldset>
                      ...
                      <input type="button" id="actualizarp1" name="next" class="next action-button" value="Siguiente" />
                      <input type="button" name="previous" class="previous action-button-previous" value="Atrás" />
                    </fieldset>
                ...
                <div id="formp2" class="card-body" style="display: none;">
                  <form id="msform2" method="post">
                    ...
                    <div class="row p-2">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <ul id="progressbar">
                          <li class="active" id="user"><strong></strong></li>
                          <li class="active" id="home"><strong></strong></li>
                          <li class="active" id="list"><strong></strong></li>
                          <li class="active" id="student"><strong></strong></li>
                          <li id="confirm"><strong></strong></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <fieldset>
                      ...
                      <input id="actualizar2" type="button" name="next" class="btn btn-md btn-danger action-button" value="Finalizar" />
                      <!-- <input type="button" name="previous" class="previous action-button-previous" value="Atrás" /> -->
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#actualizarp2').click(function() {
        var datos = $('#msform2').serialize();
        $.ajax({
          type: "POST",
          url: "procesos/actualizar_ficha_familia.php",
          data: datos,
          success: function(r) {
            if (r == 1) {
              Swal.fire({
