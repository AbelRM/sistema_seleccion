            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 d-flex justify-content-center">
                  <a href="lista_postu_cas_total.php?&idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>" class="btn btn-secondary" type="button"><i class="fas fa-arrow-circle-left"></i> Retroceder</a>
                </div>
                <div class="col-6 d-flex justify-content-center">
