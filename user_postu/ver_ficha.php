            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center ">
                    <div class="card border-primary mb-3 font-weight-bold" style="color:#000;">
                        ...
                        <a href="reporteficha.php?idpostulante=<?php echo $idpostulante?>"><button type="button" class="btn btn-primary" id="editar" style="margin: 1px;"><i class="fa fa-pencil-alt"></i>Postular</button></a>
                        <div class="card-body">
                            <?php 
