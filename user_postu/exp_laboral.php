          ...
          <form action="procesos/guardar_experiencia.php" enctype="multipart/form-data" autocomplete="off" method="POST">
            <div class="row">
              ...
              <div class="col-md-8 col-sm-12">
                ...
                <select class="form-control" name="nombre_lugar_gene" id="nombre_lugar_gene" required>
              ...
              <div class="col-md-4 col-sm-12" id="div_nombre_lugar_espec">
              ...
              <div class="col-md-4 col-sm-12" id="div_centro_estudios">
              ...
              <div class="col-md-12 col-sm-12" id="archivo">
                <label for="title" class="text-primary font-weight-bolder">(*) Subir Contrato, Constancia/Certificado + boleta o Orden de servicio + recibo honorarios 
                (segun se requiera)</label>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="procesos/actualizar_experiencia.php" enctype="multipart/form-data" autocomplete="off" method="POST">
            ...
            <div class="form-group">
              <label for="title">Lugar de Trabajo general</label>
              <select class="form-control" name="update_lugar_gene" id="id_lugar_espec" required>
                <option value="0">Seleccione:</option>
                <?php
                $query = $con->query("SELECT * FROM lugar_trabajo_gene");
                while ($valores = mysqli_fetch_array($query)) {
