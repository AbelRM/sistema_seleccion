          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan='2' style="font-size: 14px; font-weight:900;"><input type="number" class="form-control text-center valor" name="aspec_perso" id="valor_1" value="<?php if ($aspecto_personal == NULL) {
                                                                                                                                                                                      } else {
                      ...
                      <tr>
                        ...
                        <td colspan='2' style="font-size: 14px; font-weight:900;"><input type="number" class="form-control text-center valor" name="segu_estab" id="valor_2" value="<?php if ($seguridad_estabilidad == NULL) {
                                                                                                                                                                                    } else {
                      ...
                      <tr>
                        ...
                        <td colspan='2' style="font-size: 14px; font-weight:900;"><input type="number" class="form-control text-center valor" name="etica" id="valor_3" value="<?php if ($capacidad_persu == NULL) {
                                                                                                                                                                                } else {
                      ...
                      <tr>
                        ...
                        <td colspan='2' style="font-size: 14px; font-weight:900;"><input type="number" class="form-control text-center valor" name="compet" id="valor_4" value="<?php if ($capacidad_decisi == NULL) {
                                                                                                                                                                                } else {
                      ...
                      <tr>
                        ...
                        <td colspan='2' style="font-size: 14px; font-weight:900;"><input type="number" class="form-control text-center valor" name="cono_cult" id="valor_5" value="<?php if ($conocimiento_gen == NULL) {
                                                                                                                                                                                    } else {
              ...
              <div class="row d-flex justify-content-center m-3">
                <a href="lista_postu_cas_total.php?idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>" type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>
              </div>
            </div>
          </div>
          ...
          success: function(r) {
            ...
            if (respuesta.r == 1) {
              Swal.fire({
                ...
                window.location = "lista_postu_cas_total.php?idcon=" + respuesta.idcon + "&idpersonal=" + respuesta.idpersonal + "&dni=" + respuesta.dni;
              });
            } else {
              Swal.fire({
