                ...
                <div class="card-body">
                  ...
                  <form method="POST">
                            ...
                            <div class="table-responsive">
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  ...
                                  ON personal_req.cargo_idcargo = cargo.idcargo WHERE convocatoria_idcon='$idcon'";
                    ...
                    <div class="row d-flex justify-content-center m-3">
                        <a href="listado_convocatorias.php?dni=<?php echo $dni ?>#home" type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i></i> Retroceder</a>
                     </div>
                  </form>
                </div>
              </div>
