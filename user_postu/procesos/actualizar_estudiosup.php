...
if (isset($_POST['updateData1'])) {
  ...
  if ($_FILES['archivos1']['name'] != null) {
    ...
    $centro_estu = strtoupper($_POST['centro_estu']);
  ...
  if ($_FILES['archivos2']['name'] != null) {
    ...
    $centro_estu = strtoupper($_POST['centro_estudi']);
    $especialidad = strtoupper($_POST['especialidades']);
  ...
  if ($_FILES['archivos3']['name'] != null) {
    ...
    $centro_estu = strtoupper($_POST['centro_estud']);
    $materia = strtoupper($_POST['materia1']);
    $horas = $_POST['horas1'];
    $creditos = $_POST['creditos1'];
    ...
    if (!(strpos($tipo_archivo, "pdf") && ($tamano_archivo <= 3000000))) {
      ...
      if (move_uploaded_file($_FILES['archivos3']['tmp_name'], $micarpeta . $antiguo_nombre)) {
        ...
        $sql = "UPDATE cursos_extra SET centro_estu='" . $centro_estu . "', materia='" . $materia . "',horas='" . $horas . "', creditos='" . $creditos . "',
        fech_ini='" . $fecha_inicio . "', fech_fin='" . $fecha_fin . "', tipo='" . $tipo . "', archivo='" . $antiguo_nombre . "' 
        WHERE idcursos_extra='" . $idcursos . "' ";
    ...
    $sql = "UPDATE cursos_extra SET centro_estu='" . $centro_estu . "', materia='" . $materia . "',horas='" . $horas . "', creditos='" . $creditos . "',fech_ini='" . $fecha_inicio . "', 
  ...
  if ($_FILES['archivos4']['name'] != null) {
    ...
    if (!(strpos($tipo_archivo, "pdf") && ($tamano_archivo <= 3000000))) {
      ...
      if (move_uploaded_file($_FILES['archivos4']['tmp_name'], $micarpeta . $antiguo_nombre)) {
        ...
        $sql = "UPDATE idiomas_comp SET idioma_comp='" . $idiomas . "',lugar_estudio ='".$centro_estudios_idio."', nivel='" . $nivel . "',archivo='" . $antiguo_nombre . "' WHERE ididiomas_comp='" . $ididiomas . "' ";
    ...
    $sql = "UPDATE idiomas_comp SET idioma_comp='" . $idiomas . "',lugar_estudio ='".$centro_estudios_idio."', nivel='" . $nivel . "' WHERE ididiomas_comp='" . $ididiomas . "' ";
...
} elseif (isset($_POST['updateCursosPrac'])) {
  $dato_desencriptado = $_POST['dato_desencriptado'];
  $idcursos = $_POST['idcursos_extra'];
  $dni = $_POST['dni3'];
  $verificar_archivo = $_FILES["archivos3"];
...
} elseif (isset($_POST['updateIdiomaPrac'])) {
  $dato_desencriptado = $_POST['dato_desencriptado'];
  $dni = $_POST['dni4'];
  $verificar_archivo = $_FILES["archivos4"];
  $ididiomas = $_POST['ididiomas_comp'];
  ...
  if ($_FILES['archivos4']['name'] != null) {
    ...
    $idiomas = $_POST['idioma_comp'];
    $lugar_estudio = strtoupper($_POST['centro_estudios_idio']);
    $nivel = $_POST['nivel4'];
    ...
    if (!(strpos($tipo_archivo, "pdf") && ($tamano_archivo <= 3000000))) {
      ...
      if (move_uploaded_file($_FILES['archivos4']['tmp_name'], $micarpeta . $antiguo_nombre)) {
        ...
        $sql = "UPDATE idiomas_comp SET idioma_comp='" . $idiomas . "',lugar_estudio ='".$lugar_estudio."', nivel='" . $nivel . "',archivo='" . $antiguo_nombre . "' 
        WHERE ididiomas_comp='" . $ididiomas . "' ";
    ...
    $sql = "UPDATE idiomas_comp SET idioma_comp='" . $idiomas . "',lugar_estudio ='".$lugar_estudio."', nivel='" . $nivel . "' WHERE ididiomas_comp='" . $ididiomas . "' ";
