CREATE DATABASE  IF NOT EXISTS `sistema_seleccion` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sistema_seleccion`;
-- MySQL dump 10.13  Distrib 8.0.20, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sistema_seleccion
-- ------------------------------------------------------
...
INSERT INTO `cargo` VALUES (1,'MEDICO',1),(2,'LIC. EN ENFEMERIA',1),(3,'BIOLOGO',1),(4,'QUIMICO FARMACEUTICO',1),(5,'NUTRICIONISTA',1),(6,'INGENIERO EN SISTEMAS',2),(7,'TECNICO ADMINISTRATIVO',5);
...
INSERT INTO `comision` VALUES (1,'PRESIDENTE','asda','asda','asda',1),(2,'MIEMBRO','clara','asda','Ejecutivo de gestión y desarrollo de RRHH',1),(3,'MIEMBRO','nicolas','maquera','adminiostracion',1),(4,'PRESIDENTE','Jose fernando','Venavides','Ejecutivo de gestión y desarrollo de RRHH',3),(5,'MIEMBRO','Abel','Maquera','Administracion',3),(6,'MIEMBRO','Alosn','Sacaca Perez','Ejecutivo de gestión y desarrollo de RRHH',3),(7,'PRESIDENTE','clara','sacaca','RRHH',4),(8,'MIEMBRO','sandra','maquera','ADMINISTRACION',4),(9,'MIEMBRO','Gonzalo','Fernandez','JUDICIAL',4),(10,'PRESIDENTE','nicolas','asdas','Ejecutivo de gestión y desarrollo de RRHH',7),(11,'MIEMBRO','asdas','asd','RRHH',7);
...
INSERT INTO `convocatoria` VALUES (1,'001',2020,'C.A.S.','2020-07-27','2020-07-31',70,30,15,10,0,'ACTIVO',1),(2,'001',2020,'C.A.S.','2020-07-23','2020-07-31',70,30,15,10,0,'ACTIVO',1),(3,'002',2020,'C.A.S.','2020-08-11','2020-08-31',70,30,15,10,0,'ACTIVO',2),(4,'004',2020,'C.A.S.','2020-08-15','2020-08-22',70,30,15,10,0,'ACTIVO',3),(5,'005',2020,'C.A.S.','2020-08-30','2020-09-06',70,30,15,10,0,'ACTIVO',3),(6,'006',2020,'C.A.S.','2020-08-27','2020-08-30',70,30,15,10,0,'ACTIVO',2),(7,'007',2020,'C.A.S.','2020-08-07','2020-08-25',70,30,15,10,0,'ACTIVO',3);
/*!40000 ALTER TABLE `convocatoria` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `cursos_extra`
--

LOCK TABLES `cursos_extra` WRITE;
/*!40000 ALTER TABLE `cursos_extra` DISABLE KEYS */;
INSERT INTO `cursos_extra` VALUES (3,'UNJBG','Programacion basica','120','2020-08-07','2020-08-31','CURSO','EGRESADO',4),(4,'APECID','Programacion basica','300','2020-08-16','2020-10-28','DIPLOMADO','EGRESADO',4);
/*!40000 ALTER TABLE `cursos_extra` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `datos_profesionales` WRITE;
/*!40000 ALTER TABLE `datos_profesionales` DISABLE KEYS */;
INSERT INTO `datos_profesionales` VALUES (1,'profesion','2020-07-03','unbjg','2020-07-04','123',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `datos_profesionales` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalle_convocatoria`
--

LOCK TABLES `detalle_convocatoria` WRITE;
/*!40000 ALTER TABLE `detalle_convocatoria` DISABLE KEYS */;
INSERT INTO `detalle_convocatoria` VALUES (5,4,4,7,'003266',NULL),(6,4,7,7,'004872',NULL),(7,7,7,8,'004978',''),(9,1,4,2,'004878',''),(10,7,4,9,'124578',''),(11,1,4,1,'785612','');
/*!40000 ALTER TABLE `detalle_convocatoria` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `direccion_ejec`
--

LOCK TABLES `direccion_ejec` WRITE;
/*!40000 ALTER TABLE `direccion_ejec` DISABLE KEYS */;
INSERT INTO `direccion_ejec` VALUES (1,'Direccion ejecutiva de promocion de la salud',1),(2,'Direccion ejecutiva de promocion de la salud',1),(3,'Direccion ejecutiva de salud de las personas',2);
/*!40000 ALTER TABLE `direccion_ejec` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `domicilio_post`
--

LOCK TABLES `domicilio_post` WRITE;
/*!40000 ALTER TABLE `domicilio_post` DISABLE KEYS */;
INSERT INTO `domicilio_post` VALUES (7,'AVENIDA','asdas','12','AVENIDA','asdas','12','ruta 55',NULL,NULL,NULL,4,NULL),(8,'JIRON','asdas','12','PASAJE','asdas','12','ruta 55',NULL,NULL,NULL,7,NULL),(9,'AVENIDA','asqe','12','AVENIDA','qwe','12','ruta 55','','12','23',8,NULL);
/*!40000 ALTER TABLE `domicilio_post` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `equipo_ejec`
--

LOCK TABLES `equipo_ejec` WRITE;
/*!40000 ALTER TABLE `equipo_ejec` DISABLE KEYS */;
INSERT INTO `equipo_ejec` VALUES (1,'Equipo de trabajo de educación para la salud'),(2,'Equipo de trabjo de promocion de de vida sana de emergencias y desastres'),(3,'Equipo de trabajo de fizcalizacion, contro y vigilencia sanitaria');
/*!40000 ALTER TABLE `equipo_ejec` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `estudios_superiores`
--

LOCK TABLES `estudios_superiores` WRITE;
/*!40000 ALTER TABLE `estudios_superiores` DISABLE KEYS */;
INSERT INTO `estudios_superiores` VALUES (1,'UNJBG','Ingeniero en informatica y sistemas','2011-12-10','2019-12-20','EGRESADO',NULL),(2,'UNJBG','Contabilidad','2020-07-03','2020-07-31','ESTUDIANTE',NULL),(3,'UNJBG','administracion','2020-07-04','2020-07-15','EGRESADO',NULL);
/*!40000 ALTER TABLE `estudios_superiores` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_aux_admin`
--

LOCK TABLES `eva_aux_admin` WRITE;
/*!40000 ALTER TABLE `eva_aux_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_aux_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_entrevista`
--

LOCK TABLES `eva_entrevista` WRITE;
/*!40000 ALTER TABLE `eva_entrevista` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_entrevista` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_otros_prof`
--

LOCK TABLES `eva_otros_prof` WRITE;
/*!40000 ALTER TABLE `eva_otros_prof` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_otros_prof` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_prof_salud`
--

LOCK TABLES `eva_prof_salud` WRITE;
/*!40000 ALTER TABLE `eva_prof_salud` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_prof_salud` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_tec_admin`
--

LOCK TABLES `eva_tec_admin` WRITE;
/*!40000 ALTER TABLE `eva_tec_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_tec_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_tec_enfermeria`
--

LOCK TABLES `eva_tec_enfermeria` WRITE;
/*!40000 ALTER TABLE `eva_tec_enfermeria` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_tec_enfermeria` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `eva_tec_transp`
--

LOCK TABLES `eva_tec_transp` WRITE;
/*!40000 ALTER TABLE `eva_tec_transp` DISABLE KEYS */;
/*!40000 ALTER TABLE `eva_tec_transp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `expe_1puntos`
--

LOCK TABLES `expe_1puntos` WRITE;
/*!40000 ALTER TABLE `expe_1puntos` DISABLE KEYS */;
/*!40000 ALTER TABLE `expe_1puntos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `expe_3puntos`
--

LOCK TABLES `expe_3puntos` WRITE;
/*!40000 ALTER TABLE `expe_3puntos` DISABLE KEYS */;
/*!40000 ALTER TABLE `expe_3puntos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `expe_4puntos`
--

LOCK TABLES `expe_4puntos` WRITE;
/*!40000 ALTER TABLE `expe_4puntos` DISABLE KEYS */;
/*!40000 ALTER TABLE `expe_4puntos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `familia_post`
--

LOCK TABLES `familia_post` WRITE;
/*!40000 ALTER TABLE `familia_post` DISABLE KEYS */;
INSERT INTO `familia_post` VALUES (6,'clara','sacaca','2020-07-03','00498105','MADRE','Artesana',4),(7,'nicolas','maquera','2020-07-01','00547896','PADRE','Ruta 55',4),(8,'asda','asda','2020-08-07','00498105','PADRE','ninguna',7),(9,'nicolas','sacaca','2020-08-06','00498105','MADRE','Artesana',7),(10,'nicolas','sacaca','2020-07-09','12313131','PADRE','Ruta 55',8);
/*!40000 ALTER TABLE `familia_post` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `idiomas_comp`
--

LOCK TABLES `idiomas_comp` WRITE;
/*!40000 ALTER TABLE `idiomas_comp` DISABLE KEYS */;
INSERT INTO `idiomas_comp` VALUES (1,'ingles','BASICO',4),(2,'computacion','INTERMEDIO',4);
/*!40000 ALTER TABLE `idiomas_comp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `maestria_doc`
--

LOCK TABLES `maestria_doc` WRITE;
/*!40000 ALTER TABLE `maestria_doc` DISABLE KEYS */;
/*!40000 ALTER TABLE `maestria_doc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `personal_req`
--

LOCK TABLES `personal_req` WRITE;
/*!40000 ALTER TABLE `personal_req` DISABLE KEYS */;
INSERT INTO `personal_req` VALUES (1,2,2500,'re','002',1,1),(2,8,2000,'re','002',2,1),(3,2,5000,'re','002',1,3),(4,1,2000,'re','002',6,3),(5,4,3500,'re','010',2,3),(6,1,5000,'re','002',1,4),(7,8,2000,'re','060',7,4),(8,2,5000,'R. ORDINARIOS','002',1,7),(9,1,3000,'R. ORDINARIOS','002',6,7);
/*!40000 ALTER TABLE `personal_req` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `postulante` VALUES (4,'71247189','abel','Maquera','Sacaca','SOLTERO(A)','983766054','jhanmaquera@gmail.com','MASCULINO','10712471897','2020-07-30','131231','NINGUNA','NO','1321312','asdasda','NO','NINGUNA','A-','ninguna',1511),(5,'00498105','juan','zapata','mamani',NULL,'983766054','prueba@hotmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'11111111','prueba','maque','prueba',NULL,'983766054','jhanmaquera@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'34241212','gisela','apellido1','apellido2','SOLTERO(A)','983766054','gisela@prueba.com','FEMENINO','1231231','2000-02-10','131231','NINGUNA','NO','1321312','asdasda','NO','NINGUNA','AB-','ninguna',1781),(8,'22222222','RENZO','MARILLO','SABIO','SOLTERO(A)','983766054','prueba@hotmail.com','MASCULINO','1231231','1994-10-20','131231','ONP','SI','1321312','asdasda','NO','NINGUNA','A+','ninguna',1779);
...
--
-- Dumping data for table `puntaje_curso`
--

LOCK TABLES `puntaje_curso` WRITE;
/*!40000 ALTER TABLE `puntaje_curso` DISABLE KEYS */;
/*!40000 ALTER TABLE `puntaje_curso` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `puntaje_exp_laboral`
--

LOCK TABLES `puntaje_exp_laboral` WRITE;
/*!40000 ALTER TABLE `puntaje_exp_laboral` DISABLE KEYS */;
/*!40000 ALTER TABLE `puntaje_exp_laboral` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `resultado_final`
--

LOCK TABLES `resultado_final` WRITE;
/*!40000 ALTER TABLE `resultado_final` DISABLE KEYS */;
/*!40000 ALTER TABLE `resultado_final` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipo_cargo` VALUES (1,'PROFESIONAL DE LA SALUD'),(2,'OTROS PROFESIONALES'),(3,'ASISTENTE ADMINISTRATIVO'),(4,'TECNICO EN ENFERMERIA'),(5,'TECNICO ADMINISTRATIVO'),(6,'TECNICO EN COMUNICACIONES'),(7,'SECRETARIA'),(8,'TECNICO EN INFORMATICA'),(9,'AUXILIAR ADMINISTRATIVO'),(10,'CHOFER'),(11,'VIGILANTE'),(12,'TRABAJADOR DE LIMPIEZA'),(13,'TRABAJADOR DE SERVICIOS');
...
INSERT INTO `tipo_user` VALUES (1,'ESTUDIANTE'),(2,'ADMINISTRADOR'),(3,'MAESTRO');
...
INSERT INTO `user` VALUES (5,'71247189','abel','Maquera','Sacaca',983766054,'jhanmaquera@gmail.com','202cb962ac59075b964b07152d234b70','202cb962ac59075b964b07152d234b70',1),(6,'00498105','juan','zapata','mamani',983766054,'prueba@hotmail.com','202cb962ac59075b964b07152d234b70','202cb962ac59075b964b07152d234b70',2),(7,'11111111','prueba','maque','prueba',983766054,'jhanmaquera@gmail.com','202cb962ac59075b964b07152d234b70','202cb962ac59075b964b07152d234b70',1),(8,'34241212','gisela','apellido1','apellido2',983766054,'gisela@prueba.com','202cb962ac59075b964b07152d234b70','202cb962ac59075b964b07152d234b70',1),(9,'22222222','RENZO','MARILLO','SABIO',983766054,'prueba@hotmail.com','202cb962ac59075b964b07152d234b70','202cb962ac59075b964b07152d234b70',1);
...
-- Dump completed on 2020-08-14 14:56:33
