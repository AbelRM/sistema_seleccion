...
$(function() {
    ...
    switch (selectValue) {
        case "tipo-1":
            $("#tipo-1").show(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-2":
            $("#tipo-1").hide(); $("#tipo-2").show(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-3":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").show(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-4":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").show(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-5":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").show();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-6":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").show(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-7":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").show(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-8":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").show(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-9":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").show(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-10":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").show();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-11":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").show(); $("#tipo-12").hide(); $("#tipo-13").hide();
        break;
        case "tipo-12":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").show(); $("#tipo-13").hide();
        break;
        case "tipo-13":
            $("#tipo-1").hide(); $("#tipo-2").hide(); $("#tipo-3").hide(); $("#tipo-4").hide(); $("#tipo-5").hide();
            $("#tipo-6").hide(); $("#tipo-7").hide(); $("#tipo-8").hide(); $("#tipo-9").hide(); $("#tipo-10").hide();
            $("#tipo-11").hide(); $("#tipo-12").hide(); $("#tipo-13").show();
        break;
    }
    }).change();
});
