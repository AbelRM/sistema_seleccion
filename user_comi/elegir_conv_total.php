...
<head>
  ...
  <title>ELEGIR CONVOCATORIA PARA VER REPORTES - SISTEMA DE SELECCIÓN DIRESA TACNA</title>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr style="background-color: #D5837B;">
                              ...
                              <td style="font-size: 14px; font-weight:900;"><?php echo $row['num_con'] . '-' . $row['anio_con'] ?>
                              </td>
                              ...
                              <td style="font-size: 14px; font-weight:900;"><?php echo $row['estado'] ?></td>
                              <td class="d-flex justify-content-center">
                                <button class="btn btn-primary btn-sm" type="button" data-toggle="collapse" data-target="#accordion_<?php echo $k ?>" class="clickable"><i class="far fa-list-alt"></i><label for="clickable"> VER</label> </button>
                              </td>
                            </tr>
                            <?php
                            $sql_3 = "SELECT * FROM sistema_seleccion.personal_req INNER JOIN cargo ON personal_req.cargo_idcargo = cargo.idcargo INNER JOIN ubicacion ON personal_req.personal_req_idubicacion = ubicacion.iddireccion WHERE convocatoria_idcon = '$idcon' ";
                            $resul = mysqli_query($con, $sql_3);
                            $fil_perso_req = mysqli_num_rows($resul);
                            if ($fil_perso_req > 0) {
                            ?>
                              <thead>
                                <tr id="accordion_<?php echo $k ?>" class="collapse">
                                  <th style="display:none;">id</th>
                                  <th></th>
                              ...
                              ?>
                                <tr id="accordion_<?php echo $k ?>" class="collapse">
                                  ...
                                  <td style="font-size: 12px; background-color: #8287e021;">
                                    <small style="font-weight:700; font-size: 14px;">Cargo requerido: </small><?php echo $array['cargo'] ?><br>
                                  ...
                                  <td style="font-size: 12px; background-color: #8287e021;">
                                    <a href="listado_reporte_cas.php?idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>">
                                      <button type="button" class="btn btn-success btn-sm" style="margin: 1px;"><i class="fas fa-search-plus"></i> Ver reportes</button>
                                    </a>
                                  </td>
                                </tr>
                              <?php
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr style="background-color: #D5837B;">
                              ...
                              <td style="font-size: 14px; font-weight:900;"><?php echo $row['estado_con'] ?></td>
                              <td><button class="btn btn-info btn-sm" type="button" data-toggle="collapse" data-target="#accordion" class="clickable">Mostrar</button> </td>
                            </tr>
                            <?php
                            $sql_2 = "SELECT * FROM practicantes_req INNER JOIN ubicacion ON practicantes_req.practicantes_req_idubicacion= ubicacion.iddireccion WHERE conv_idpracticas = $idpracticas";
                            $consulta = mysqli_query($con, $sql_2);
                            ?>
                            <thead id="accordion" class="collapse">
                              <tr>
                                <th style="display:none;">id</th>
                                <th></th>
                            ...
                            ?>
                              <tr id="accordion" class="collapse">
                                ...
                                <td style="font-size: 12px; background-color: #8287e021;">
                                  <a href="listado_reporte_prac.php?idpracticas=<?php echo $idpracticas ?>&idpracticantes_req=<?php echo $idpracticantes_req ?>&dni=<?php echo $dni ?>">
                                    <button type="button" class="btn btn-success btn-sm" id="editar" style="margin: 1px;"><i class="fas fa-search-plus"></i> Ver reportes</button>
                                  </a>
                                </td>
                              </tr>
                            <?php
