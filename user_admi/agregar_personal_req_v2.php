                      ...
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          ?>
                              ...
                              ?>
                                <thead>
                                  <tr style="text-align:center; color:#000; font-size:0.813em;">
                                    <th style="display:none;">id</th>
                                    <th></th>
                                    <th class="bg-secondary">Tipo de estudios</th>
                                    <th class="bg-secondary">Nivel de estudios</th>
                                    <th class="bg-secondary">Tipo experiencia</th>
                                    <th class="bg-secondary">Cantidad exp.</th>
                                    <!-- <th>Acciones</th> -->
                                  </tr>
                                </thead>
                                <?php
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td style="font-size: 12px;"><?php //echo $ii 
                                                                  ?></td>
                                    <td style="font-size: 12px;"></small><?php if ($row['reque_tipo_estudios'] == 1) {
                                                                            echo "SECUNDARIA";
                                                                          } elseif ($row['reque_tipo_estudios'] == 2) {
                                  ...
                                  <tr>
                                    ...
                                    <td style="font-size: 12px;"></small><?php if ($row['reque_tipo_estudios_max'] == 1) {
                                                                            echo "SECUNDARIA";
                                                                          } elseif ($row['reque_tipo_estudios_max'] == 2) {
                                                                            echo "TECNICO SUPERIOR";
                                                                          } else {
                                                                            echo "UNIVERSITARIO";
                                                                          } ?></td>
