...
<head>
  ...
  <title>VER CONVOCATORIA CAS - SISTEMA SELECCION (DIRESA-TACNA)</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="tab-content" id="myTabContent">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            ...
                            $sql = "SELECT * FROM sistema_seleccion.personal_req INNER JOIN sistema_seleccion.ubicacion 
                                  ON personal_req.personal_req_idubicacion = ubicacion.iddireccion INNER JOIN sistema_seleccion.cargo_full ON personal_req.cargo_idcargo = cargo_full.idcargo
                    ...
                    <div class="tab-pane fade" id="comision" role="tabpanel" aria-labelledby="comision-tab">
                          ...
                          <div class="col-12">
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <?php
                                $idcon = $_GET['idcon'];
                                $sql = "SELECT * FROM sistema_seleccion.comision WHERE convocatoria_idcon='$idcon'";
                                $query = mysqli_query($con, $sql);
                                $i = 1;
                                if (mysqli_num_rows($query) > 0) {
                                  while ($row = mysqli_fetch_array($query)) {
      ...
      <!-- ADD NUEVOS DATOS PERSONAL REQUERIDO -->
              ...
              <form action="procesos/guardar_personal_req_v2.php" autocomplete="off" method="POST">
                <div class="row">
                  ...
                  <div class="col-md-9 col-sm-12 form-group">
                    ...
                    <select name="chosen-unique" class="chosen" data-placeholder="Elige la ubicación del personal requerido" required>
                      <option value=""></option>
                      <?php
                  ...
                  <div class="col-md-4 col-sm-12 form-group" id="div_nivel_estudio_prof">
                    ...
                    <select name="nivel_estudios" onChange="tipo_nivel_estudio_select(this)" class="form-control">
                  ...
                  <div class="col-md-4 col-sm-12 form-group" id="div_experiencia_años">
                    <label for="title">(*) Tiempo experiencia</label>
                    <input type="number" name="cantidad_experiencia" class="form-control">
                  </div>
                  <div class="col-md-4 col-sm-12 form-group">
                ...
                <div class="modal-footer">
                  <button type="submit" name="insertPersoReq" class="btn btn-primary">Guardar</button>
                </div>
              </form>
            </div>
          </div>
