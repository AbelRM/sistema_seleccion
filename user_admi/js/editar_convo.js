...
$(function() {
  $("#select_nivel_estu_prof").on('change', function() {
    var selectValue = $(this).val();
    switch (selectValue) {
      case "ESTUDIANTE":
...
$(function() {
  $("#select_formacion_requerida_max").on('change', function() {
    ...
    switch (selectValue) {
      case "1":
        $("#div_nivel_estudio_tecnico_max").hide();
        ...
        break;
      case "2":
        $("#div_nivel_estudio_tecnico_max").show();
        $("#div_nivel_estudio_prof_max").hide();
        $("#div_ciclo_actual_max").hide();
        $("#div_colegiatura_max").hide();
        $("#div_habilitacion_max").hide();
...
$(function() {
  $("#select_nivel_estudio_prof_max").on('change', function() {
    var selectValue = $(this).val();
    switch (selectValue) {
      case "ESTUDIANTE":
...
$(function() {
  $("#select_experiencia").on('change', function() {
    var selectValue = $(this).val();
    switch (selectValue) {
      case "anios":
        $("#div_experiencia_meses").hide();
        $("#div_cant_anios").show();
        break;
      case "meses":
        $("#div_experiencia_meses").show();
        $("#div_cant_anios").hide();
        break;
