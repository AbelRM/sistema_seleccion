...
<head>
  ...
  <title>Listado total de postulantes con resultados - DIRESA TACNA</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">LISTADO DE POSTULANTES TOTALES CON PUNTAJE CURRICULAR</h6>
            </div>
            <?php
            ...
            <div class="card-body">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-link font-weight-bold active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Lista de postulantes APTOS</a>
                  <a class="nav-link font-weight-bold" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Lista de depostulantes TOTAL</a>
                </div>
              </nav>
                          ...
                          <tr>
                            ...
                            <td style="font-size: 14px;">
                              <div class="row">
                                <div class="col-6">
                                  <small style="font-weight:700; font-size: 14px;">Puntaje Formación:</small><br><?php echo $row['punt_total_forma'] ?> Puntos<br>
                                  <small style="font-weight:700; font-size: 14px;">Puntaje Idioma/Comput.</small><br><?php echo $row['idioma_compu'] ?> Puntos<br>
                                  <small style="font-weight:700; font-size: 14px;">Puntaje Capacitaciones</small><br><?php echo $row['punt_total_cursos'] ?> Puntos

                                </div>
                                <div class="col-6">
                                  <small style="font-weight:700; font-size: 14px;">Puntaje Exp. laboral total</small><br><?php echo $row['punt_total_expe'] ?> Puntos<br>
                                  <small style="font-weight:700; font-size: 14px;">Punt. Exp. laboral (4 puntos)</small><br><?php echo $row['expe_laboral_cuatro'] ?> Puntos<br>
                                  <small style="font-weight:700; font-size: 14px;">Punt. Exp. laboral (3 puntos)</small><br><?php echo $row['expe_laboral_tres'] ?> Puntos<br>
                                  <small style="font-weight:700; font-size: 14px;">Punt. Exp. laboral (1 puntos)</small><br><?php echo $row['expe_laboral_uno'] ?> Puntos<br>
                                </div>
                              </div>
                            </td>
                            <td style="font-size: 14px;"><?php echo $row['puntaje_total_total'] ?> Puntos</td>
                            <td style="font-size: 14px;"><?php echo $row['estado_conv_cas'] ?></td>
                            <td>
              ...
              <div class="row d-flex justify-content-center m-3">
                <a href="elegir_conv_cal.php?dni=<?php echo $dni ?>" type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i> Retroceder</a>
              </div>
            </div>
          </div>
