                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12 d-2 d-flex justify-content-center">
                          <a href="listar_convo.php?dni=<?php echo $dni ?>"><button type="button" class="btn btn-danger"><i class="far fa-hand-pointer"></i> Elegir</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12 p-2">
                          <div class="col-md-12 d-2 d-flex justify-content-center">
                            <a href="lista_conv_pract.php?dni=<?php echo $dni ?>" type="button" class="btn btn-primary"><i class="far fa-hand-pointer"></i> Elegir</a>
                          </div>
                        </div>
                      </div>
                    </div>
