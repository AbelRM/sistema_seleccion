                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="cargo_prac.php?idpracticas=<?php echo $row['idpracticas'] ?>&dni=<?php echo $dni ?>"><button type="button" class="btn btn-primary" style="margin: 1px;"><i class="fa fa-pencil-alt"></i> Postular</button></a>
                      </td>
