                  ...
                  <tbody>
                    ...
                    ?>
                        <tr style="background-color: #8287e061;">
                          ...
                          <td>
                            <a href="registrar_postulacion.php?idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dni ?>&idcon=<?php echo $idcon ?>">
                              <button type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i> Elegir</button>
                            </a>
                          </td>
                        </tr>
                        <?php
                        ...
                        ?>
                          <tr>
                            ...
                            <td style="font-size: 12px;">
                              ...
                              echo "SECUNDARIA";}elseif($rw['reque_tipo_estudios']==2){echo "TECNICO SUPERIOR";}else{echo "UNIVERSITARIO";} ?><br>
                          ...
                          <tr>
                            ...
                            <td style="font-size: 12px;">
                              ...
                              echo "SECUNDARIA";}elseif($rw['reque_tipo_estudios_max']==2){echo "TECNICO SUPERIOR";}else{echo "UNIVERSITARIO";} ?><br>
