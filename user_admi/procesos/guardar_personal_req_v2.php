...
if (isset($_POST['agregar_personal'])) {
  ...
  $meta = $_POST['meta'];
  $direccion_ejecutora = $_POST['direccion_ejecutora'];
  $ubicacion_postu = $_POST['ubicacion_postu'];


  $sql = "INSERT INTO personal_req (cantidad,remuneracion,fuente_finac,meta,cargo_idcargo,convocatoria_idcon,personal_req_idubicacion,personal_req_ubicacion_postu) 
    VALUES('" . $cantidad . "','" . $remuneracion . "','" . $fuente_finac . "','" . $meta . "','" . $cargo . "','" . $idcon . "','" . $direccion_ejecutora . "', '" . $ubicacion_postu . "')";
  ...
  if ($result) {
    ...
    if ($reque_tipo_estudios_max == 1) {
      ...
      $nivel_estudios_max = $_POST['nivel_estudios_prof_max'];
    }
  ...
  if ($tipo_practicante == 'PRE-PROFESIONAL') {
    ...
    $sql = "INSERT INTO practicantes_req (tipo_practicante,cantidad_req,remuneracion,fuente_finac,meta,id_carrera_req,conv_idpracticas,practicantes_req_idubicacion,nivel_estudio,ciclo_requerido) 
    ...
    $sql = "INSERT INTO practicantes_req (tipo_practicante,cantidad_req,remuneracion,fuente_finac,meta,id_carrera_req,conv_idpracticas,practicantes_req_idubicacion,nivel_estudio) 
