        ...
        <div class="container-fluid">
          ...
          <div class="card border-success">
            ...
            <div class="card-body">
              ...
              <form action="procesos/actualizar_formacion.php" enctype="multipart/form-data" autocomplete="off" method="POST">
                <div class="row">
                  ...
                  <input type="hidden" name="dni_descrip" value="<?php echo $dato_desencriptado ?>">
            ...
            <div class="modal-footer">
              <a href="formacion.php?dni=<?php echo $dni  ?>" type="button" class="btn btn-default">Cancelar</a>
