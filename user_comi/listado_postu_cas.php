    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
          $consul_tabla = "SELECT * FROM personal_req Inner join convocatoria ON personal_req.convocatoria_idcon = convocatoria.idcon INNER JOIN cargo_full ON personal_req.cargo_idcargo = cargo_full.idcargo WHERE convocatoria_idcon = '$idcon' AND idpersonal='$idpersonal'";
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="curricular" role="tabpanel" aria-labelledby="curricular-tab">
                  ...
                  <div class="row m-2">
                    ...
                    <div class="col-md-4 col-sm-12 d-flex justify-content-center">
                      <a href="reportes_diresa/resultado_curricular_aptos.php?idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dato_desencriptado ?>" target="_blank"><button type="button" class="btn btn-success btn-sm m-1"><i class="far fa-file-pdf"></i> Reporte Eva. Curricular Aptos</button></a>
                    </div>
                    <div class="col-md-4 col-sm-12 d-flex justify-content-center">
                      <a href="reportes_diresa/resultado_curricular_no_aptos.php?idcon=<?php echo $idcon ?>&idpersonal=<?php echo $idpersonal ?>&dni=<?php echo $dato_desencriptado ?>" target="_blank"><button type="button" class="btn btn-danger btn-sm m-1"><i class="far fa-file-pdf"></i> Reporte Eva. Curricular Total</button></a>
                    </div>
                  </div>
