  ...
  <div id="wrapper">  
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row ">
                        <div class="col-12 p-2 d-flex justify-content-center">
                        <div class="text-xs font-weight-bold text-success  text-uppercase mb-1">Estudios superiores</div>
                        </div>
                        <div class="col-6 p-2 d-flex justify-content-center">
                            <button class="btn btn btn-success" data-toggle="modal" data-target="#estudios_postgrado">+ <i class="fas fa-user-graduate"></i></button>
                        </div>
                        <div class="col-6 p-2 d-flex justify-content-center">
                            <button class="btn btn btn-success" data-toggle="modal" data-target="#estudios_postgrado"><i class="fas fa-eye"></i></button>
                        </div>
                    </div>
                </div>
              </div>
        ...
        <!-- FORMULARIO MICRORED -->
        <div class="form-row formulario p-2">
        ...
        <!-- FORMULARIO SECTOR PUBLICO O PROVADO DENTRO O FUERA DE TACNA -->
        <div class="form-row formulario p-2">
            <div class="card border-primary">
                <div class="card-header">
  ...
  <!-- <div class="modal fade bd-example-modal-lg" id="ver_datos_profesionales" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <?php
             $consulta2="SELECT * FROM datos_profesionales where dni=$idpostulante";
             $dato2s=mysqli_query($con,$consulta2) or die(mysqli_error()); ;
        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Profesión</label>
                    <input type="text" class="form-control" id="profesion" name="profesion" value="<?php echo $row2['profesion'];?>">
                </div>
                <div class="form-group col-md-3">
                    <label for="inputPassword4">Fecha colegiatura</label>
                    <input type="date" class="form-control" id="fecha_cole" name="fecha_cole" value="<?php echo $row2['fecha_cole']; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Lugar de colegiatura</label>
                    <input type="text" class="form-control" id="lugar_cole" name="lugar_cole" value="<?php echo $row2['lugar_cole']; ?>">
                </div>
               
                <div class="form-group col-md-3">
                    <label for="inputPassword4">Fecha de habilitación</label>
                    <input type="date" class="form-control" id="fech_habi" name="fech_habi" value="<?php echo $row2['fecha_habi']; ?>">
                </div>
                <div class="form-group col-md-3">
                    <label for="inputPassword4">N° de colegiatura</label>
                    <input type="text" class="form-control" id="num_cole" name="num_cole" value="<?php echo $row2['nro_cole']; ?>">
                </div>
            </div>
        </div>
        <div class="modal-footer">
