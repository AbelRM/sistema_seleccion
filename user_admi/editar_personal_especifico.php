...
<body id="page-top">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  $sql = "SELECT * FROM personal_req INNER JOIN ubicacion 
                      ON personal_req.personal_req_idubicacion = ubicacion.iddireccion INNER JOIN cargo_full 
                  ...
                  <form action="procesos/modificar_convoca.php" autocomplete="off" method="POST">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-sm-12 form-group">
                        ...
                        <label for="title">(*) Cargo requerido</label>
                      ...
                      <div class="col-md-2 col-sm-12 form-group">
                        ...
                        <input style="font-size:13px;" type="number" name="remuneracion" value="<?php echo $row['remuneracion']; ?>" class="form-control name_list" required />
                      </div>
                      <div class="col-md-3 col-sm-12 form-group">
                      ...
                      <div class="col-md-2 col-sm-12 form-group">
                        ...
                        <input style="font-size:13px;" type="text" name="meta" value="<?php echo $row['meta']; ?>" class="form-control name_list" required />
                      </div>
                      <div class="col-md-12 col-sm-12 form-group">
                        <?php $direccion = $row['personal_req_idubicacion']; ?>

                        <label for="title">Dirección ejecutora del personal requerido (si no se va hacer cambios, dejar tal y como esta)</label><br>
                        <?php
                        $direccion_consul = "SELECT * FROM ubicacion WHERE iddireccion= '$direccion'";
                        $res = mysqli_query($con, $direccion_consul);
                        $arr = mysqli_fetch_array($res);
                        $direccion_ejec = $arr['direccion_ejec'];
                        $equipo_ejec = $arr['equipo_ejec'];
                        ?>
                        <small class="text-primary font-weight-bold">Opcion elegida: <?php echo $direccion_ejec . " - " . $equipo_ejec; ?></small>
                        <select name="direccion" class="select_direccion" data-placeholder="Elige la ubicación del personal requerido" id="select_direccion_req">
                          <option value=""></option>
                          <?php
                      ...
                      <div class="col-md-12 col-sm-12 form-group">
                        <?php $ubicacion = $row['personal_req_ubicacion_postu']; ?>
                        <label for="title">Ubicación del personal requerido (si no se va hacer cambios, dejar tal y como esta)</label><br>
                        <?php
                        ...
                        $equipo_ejec = $arr['equipo_ejec'];
                        ?>
                        <small class="text-success font-weight-bold">Opcion elegida: <?php echo $direccion_ejec . " - " . $equipo_ejec; ?></small>
                        <select name="ubicacion" class="select_ubicacion" data-placeholder="Elige la ubicación del personal requerido" id="select_ubicacion_req">
                          <option value=""></option>
                          <?php
                          $sql = "SELECT * FROM ubicacion";
                          $res = mysqli_query($con, $sql) or die("Problemas en consulta") . mysqli_error($res);
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_nivel_estudio_tecnico">
                        <?php $nivel_estudio_tec = $array['nivel_estudio']; ?>
                        <label for="title">(*) Nivel estudios técnico</label>
                        <select name="nivel_estudios_tec" id="select_nivel_estudio_tec" class="form-control">
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_nivel_estudio_prof">
                        <?php $nivel_estudio_prof = $array['nivel_estudio']; ?>
                        <label for="title">(*) Nivel estudios profesional</label>
                        <select name="nivel_estudios_prof" id="select_nivel_estu_prof" class="form-control">
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_colegiatura">
                        <?php $colegiatura = $array['colegiatura']; ?>
                        <label for="title">(*) Colegiatura </label>
                        <select name="colegiatura" id="colegiatura" class="form-control">
                          <option value="NO">NO</option>
                          <option value="SI">SI</option>
                        </select>
                      </div>
                      <div class="col-md-4 col-sm-12 form-group" id="div_habilitacion">
                        <?php $habilitacion = $array['habilitacion']; ?>
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_nivel_estudio_tecnico_max">
                        <?php $tipo_nivel_estudio_tec_max = $array['nivel_estudio_max']; ?>
                        <label for="title">(*) Nivel estudios</label>
                        <select name="nivel_estudios_tec_max" id="select_nivel_estudios_tec_max" class="form-control">
                          <option value="">Elegir...</option>
                          <option value="TITULADO TECNICO">Titulado Técnico</option>
                          <option value="EGRESADO TECNICO">Egresado Técnico</option>
                        </select>
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_nivel_estudio_prof_max">
                        <?php $tipo_nivel_estudio_prof_max = $array['nivel_estudio_max']; ?>
                        <label for="title">(*) Nivel estudios</label>
                        <select name="nivel_estudios_max" id="select_nivel_estudio_prof_max" class="form-control">
                          <option value="NINGUNO">Elegir...</option>
                          <option value="ESTUDIANTE">Estudiante</option>
                          <option value="EGRESADO">Egresado</option>
                          <option value="BACHILLER">Bachiller</option>
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_colegiatura_max">
                        <?php $colegiatura_max = $array['colegiatura_max']; ?>
                        <label for="title">(*) Colegiatura</label>
                        <select name="colegiatura_max" id="colegiatura_max" class="form-control">
                          <option value="NO">NO</option>
                          <option value="SI">SI</option>
                        </select>
                      </div>
                      <div class="col-md-4 col-sm-12 form-group" id="div_habilitacion_max">
                        <?php $habilitacion_max = $array['habilitacion_max']; ?>
                        <label for="title">(*) Habilitación Profesional</label>
                        <select name="habilitacion_max" id="habilitacion_max" class="form-control">
                          <option value="NO">NO</option>
                          <option value="SI">SI</option>
                        </select>
                      </div>
                      <div class="col-md-4 col-sm-12 form-group" id="div_serums_max">
                        <?php $serums_max = $array['serums_max']; ?>
                        <label for="title">(*) SERUMS </label>
                        <select name="serums_max" id="serums_max" class="form-control">
                          <option value="NO">NO</option>
                          <option value="SI">SI</option>
                        </select>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-12 form-group" id="div_experiencia_meses">
                        ...
                        <input type="number" name="cantidad_meses" class="form-control" value="<?php echo $array['cantidad_experiencia']; ?>">
                      </div>
                      <div class=" col-md-4 col-sm-12 form-group" id="div_cant_anios">
                        <label for="title" id="labe_exp_anios">(*) Tiempo experiencia en AÑOS</label>
                        <input type="number" name="cantidad_anios" value="<?php echo $array['cantidad_experiencia']; ?>" class="form-control">
                      </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#select_direccion_req > option[value="<?php echo $direccion ?>"]').attr('selected', 'selected');
      ...
      $('#select_nivel_estudio_tec > option[value="<?php echo $nivel_estudio_tec ?>"]').attr('selected', 'selected');
      $('#select_nivel_estu_prof > option[value="<?php echo $nivel_estudio_prof ?>"]').attr('selected', 'selected');
      $('#select_ciclo_actual > option[value="<?php echo $ciclo_actual ?>"]').attr('selected', 'selected');
      $('#colegiatura > option[value="<?php echo $colegiatura ?>"]').attr('selected', 'selected');
      $('#habilitacion > option[value="<?php echo $habilitacion ?>"]').attr('selected', 'selected');
      $('#serums > option[value="<?php echo $serums ?>"]').attr('selected', 'selected');
      ...
      $('#select_nivel_estudios_tec_max > option[value="<?php echo $tipo_nivel_estudio_tec_max ?>"]').attr('selected', 'selected');
      $('#select_nivel_estudio_prof_max > option[value="<?php echo $tipo_nivel_estudio_prof_max ?>"]').attr('selected', 'selected');
      $('#select_ciclo_actual_max > option[value="<?php echo $ciclo_actual_max ?>"]').attr('selected', 'selected');
      $('#colegiatura_max > option[value="<?php echo $colegiatura_max ?>"]').attr('selected', 'selected');
      $('#habilitacion_max > option[value="<?php echo $habilitacion_max ?>"]').attr('selected', 'selected');
      $('#serums_max > option[value="<?php echo $serums_max ?>"]').attr('selected', 'selected');
    });
  </script>
