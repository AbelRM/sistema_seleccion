...
<head>
  ...
  <title>INGRESO DE DATOS PARA PRACTICANTES - SISTEMA DE SELECCIÓN DIRESA TACNA</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">INGRESO DE DATOS PROFESIONALES PARA PRACTICANTES</h6>
            </div>
            <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 p-2">
                          <div class="col-md-12 d-2 d-flex justify-content-center">
                            <a href="formacion_prac.php?dni=<?php echo $dni ?>" type="button" class="btn btn-success"><i class="far fa-hand-pointer"></i> Elegir</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12 d-2 d-flex justify-content-center">
                          <a href="capacitacion_prac.php?dni=<?php echo $dni ?>" type="button" class="btn btn-warning"><i class="far fa-hand-pointer"></i> Elegir</a>
                        </div>
                      </div>
                    </div>
                  </div>
