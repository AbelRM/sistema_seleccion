                        ...
                        <tbody>
                          ...
                          ?>
                              ...
                              <tr>
                                ...
                                <td style="font-size: 12px;"><?php echo $row['carrera_prof'] ?></td>
          ...
          <form action="procesos/guardar_personal_req_v2.php" autocomplete="off" method="POST">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 form-group">
                ...
                <input style="font-size:12px; text-transform: uppercase;" type="text" name="carrera" class="form-control name_list" required />
              </div>
              <div class="col-md-3 col-sm-12 form-group">
