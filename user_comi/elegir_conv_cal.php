                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <?php
                            $sql_3 = "SELECT * FROM personal_req INNER JOIN cargo ON personal_req.cargo_idcargo = cargo.idcargo INNER JOIN ubicacion ON personal_req.personal_req_idubicacion = ubicacion.iddireccion WHERE convocatoria_idcon = '$idcon' ";
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <?php
                            $sql_2 = "SELECT * FROM practicantes_req INNER JOIN ubicacion ON practicantes_req.practicantes_req_idubicacion= ubicacion.iddireccion INNER JOIN carrera ON practicantes_req.id_carrera_req = carrera.idcarrera WHERE conv_idpracticas = $idpracticas";
                            ...
                            ?>
                              <tr>
                                ...
                                <td style="font-size: 12px; background-color: #8287e021;">
                                  ...
                                  <small style="font-weight:700; font-size: 14px;">Carrera requerida: </small><?php echo $rw['nomb_carrera'] ?><br>
                                ...
                                <td style="font-size: 12px; background-color: #8287e021;">
                                  ...
                                  <!-- <a href="lista_postu_prac_total.php?idpracticas=<?php echo $idpracticas ?>&idpracticantes_req=<?php echo $idpracticantes_req ?>&dni=<?php echo $dni ?>">
                                    <button type="button" class="btn btn-primary btn-sm" id="editar" style="margin: 1px;"><i class="far fa-list-alt"></i> Lista TOTAL + Puntaje</button>
                                  </a> -->
                                  <!-- <a href="lista_postu_prac_apto.php?idpracticas=<?php echo $idpracticas ?>&idpracticantes_req=<?php echo $idpracticantes_req ?>&dni=<?php echo $dni ?>">
                                    <button type="button" class="btn btn-warning btn-sm" id="editar" style="margin: 1px;"><i class="fas fa-list-ol"></i> Lista APTOS</button>
                                  </a> -->
                                </td>
                              </tr>
                            <?php
