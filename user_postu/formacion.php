          ...
          <div class="card border-success">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <h6 class="text-primary" style="font-weight: 700;">SE RECOMIENDA registrar solo un registro, acorde al puesto a postular.</h6>
                <p class="text-danger font-weight-bold">RECUERDE: La formación academica registrada va ser validada en la SUNEDU, caso se encuentre información errónea
                  abtenerse a sanciones.</p>
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          <td style="display:none"><?php echo $row['id_formacion'] ?></td>
                          ...
                          <td><a href="ver_formacion.php?id=<?php echo $row['id_formacion'] ?>&dni=<?php echo $dni ?>" target="_blank"><?php echo $row['archivo']; ?></a></td>
                          <td class="d-flex justify-content-center">
                            <a type="button" href="editarformacion.php?idformacion=<?php echo $row['id_formacion'] ?>&dni=<?php echo $dni ?>" class="btn btn-success btn-sm m-1">
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 form-group">
                  <ul class="text-danger font-weight-bolder">
                    ...
                    <li>(**) En el campo "FECHA" debe indicar la fecha de obtención del "NIVEL DE ESTUDIOS" que está registrando.
                      En el caso de estudiante universitario, debe indicar la fecha del ciclo culminado que está registrando.</li>
                  </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-12 form-group" id="div_valor_quintil">
                  ...
                  <select name="quintil" id="quintil" class="form-control">
                    ...
                    <option value="15">1 - EXTREMA POBREZA</option>
                    <option value="10">2 - MUY POBRE</option>
                    <option value="15">3 - POBRE</option>
                    <option value="2">4 - REGULAR</option>
                    <option value="0">5 - ACEPTABLE</option>
                  </select>
                </div>
